...
// http://localhost:3000/bill/63aa05847bab0845931b3780/invoice/IN-1
const Invoice = (document) => {
    ...
    return (
        <div className='a4sheet'>
            <div className='a4in'>
                <h1 className='heading1'>Invoice</h1>
                ...
                <div className='s2'>
                    <div className='s2in'>
                        ...
                        <div className='s2cont'>
                            ...
                            <p>{doc.doc.basicform.invoiceumber ? doc.doc.basicform.invoiceumber : '-'}</p>
                        </div>
                    </div>
                ...
                <div className='s5'>
                    ...
                    <div className='s5in11'>
                        ...
                        <div className='s5in1'>
                            ...
                            <p>Rs. {getfinaltotal - doc.doc.costform.discount - doc.doc.costform.advancepayment}</p>
                        </div>
                    </div>
                </div>
